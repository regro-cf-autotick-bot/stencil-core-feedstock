...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/stencil-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/stencil-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add stencil-core
# for installing globally
pixi global install stencil-core
```
...
It is possible to list all of the versions of `stencil-core` available on your platform:
...
```
pixi search stencil-core --channel conda-forge
```
